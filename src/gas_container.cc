...
GasContainer::GasContainer(const int kWindowSize, const int kMargin, ci::Color kBorderColor) : kWindowSize_(kWindowSize),
...
void GasContainer::Display() const {
  ...
  ci::gl::drawStrokedRect(ci::Rectf(vec2(kMargin_, kMargin_),
